...
/**
 * Layout component for authenticated users who are in the onboarding flow
 * (joining or requesting a tenant)
 */
export default function OnboardingLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Content */}
      <main className="py-6">
        <Container size="sm" className="mx-auto px-4 sm:px-6 lg:px-8">
          <Outlet />
        </Container>
      </main>
    </div>
